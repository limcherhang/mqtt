...
with conn.cursor() as cursor:
	...
	dataETLName like %s and Protocol='Name' and list.gatewayId>0
	"""
	...
	for rows in cursor:
		...
		with conn.cursor() as cursor:
			sqlCommand="""
			Select netAccumulator From dataETL.flowU
...
#st=datetime(2021, 5, 19, 0, 0)
#et=datetime(2021, 5, 20, 0, 0)
...
for i in range(len(dataETLName)):
	...
	with conn.cursor() as cursor:
		sqlCommand="""
		Select ts, flowRate, netAccumulator From dataETL.flowU
