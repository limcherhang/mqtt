...
sqlCommad = f"select siteId, name, tableDesc, gatewayId, protocol, dataETLName, dataETLValue from mgmtETL.NameList where tableDesc='co2' and gatewayId=261 and protocol is NOT NULL"
