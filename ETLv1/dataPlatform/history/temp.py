...
#et = nowTime
st = datetime(2023, 4, 1, 0, 0, 0)
print ("Time st :", st)
et = datetime(2023, 4, 5, 0, 0, 0)
print ("Time et :", et)
...
sqlCommand = f"select siteId, name, tableDesc, gatewayId, protocol, dataETLName, dataETLValue from mgmtETL.NameList where tableDesc='temp' and siteId=10 and gatewayId>0 and protocol is not NULL and siteId!=35"
