                ...
                for s in cursor_1:
                    ...
                    while etime <= et: 
                        ...
                        with conn.cursor() as cursor_2:
                            sql_2 = f"SELECT ts,mileage,distance,fuelConsumption,totalFuelConsumption FROM dataPlatform.car where name = '{name}' and ts >= '{stime}' and ts < '{etime}' and siteId = {sId} order by ts desc limit 1"
