...
echo "chiller Temp Supply $tempSupplyMin $tempSupplyMedian $tempSupplyMax"
...
echo "chiller Temp Return $tempReturnMin $tempReturnMedian $tempReturnMax"
...
echo "chiller Temp Delta $tempDeltaMin $tempDeltaMedian $tempDeltaMax"
chillerReturnMin=$tempReturnMin 
chillerReturnMedian=$tempReturnMedian
chillerReturnMax=$tempReturnMax
chillerSupplyMin=$tempSupplyMin
chillerSupplyMedian=$tempSupplyMedian
chillerSupplyMax=$tempSupplyMax
chillerDeltaMin=$tempDeltaMin 
chillerDeltaMedian=$tempDeltaMedian
chillerDeltaMax=$tempDeltaMax
...
echo "cooling Temp Supply $tempSupplyMin $tempSupplyMedian $tempSupplyMax"
...
echo "cooling Temp Return $tempReturnMin $tempReturnMedian $tempReturnMax"
...
echo "cooling Temp Delta $tempDeltaMin $tempDeltaMedian $tempDeltaMax"
...
VALUES('$startDay','$siteId','$gId',
	if($chillerSupplyMin is NULL,NULL,'$chillerSupplyMin'),
	if($chillerSupplyMedian is NULL,NULL,'$chillerSupplyMedian'),
	if($chillerSupplyMax is NULL,NULL,'$chillerSupplyMax'),
	if($chillerReturnMin is NULL,NULL,'$chillerReturnMin'),
	if($chillerReturnMedian is NULL,NULL,'$chillerReturnMedian'),
	if($chillerReturnMax is NULL,NULL,'$chillerReturnMax'),
	if($chillerDeltaMin is NULL,NULL,'$chillerDeltaMin'),
	if($chillerDeltaMedian is NULL,NULL,'$chillerDeltaMedian'),
	if($chillerDeltaMax is NULL,NULL,'$chillerDeltaMax'),
...
mysql -h ${host} -D$dbRPF -ss -e"REPlACE INTO dailyPlantWaterTemp(operationDate,siteId,gatewayId,
	chillerSupplyMin,chillerSupplyMedian,chillerSupplyMax,
	chillerReturnMin,chillerReturnMedian,chillerReturnMax,
	chillerDeltaMin,chillerDeltaMedian,chillerDeltaMax,
	coolingReturnMin,coolingReturnMedian,coolingReturnMax,
