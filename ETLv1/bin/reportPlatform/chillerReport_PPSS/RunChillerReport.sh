...
do
	...
	deviceDesc=${flowCombinedDeviceDesc[$arrNum]}
	deviceIEEE=${flowCombinedIEEE[$arrNum]}
	deviceTable=${flowCombinedTable[$arrNum]}
	...
	echo "  $deviceDesc $deviceIEEE $deviceTable '$startDay' '$gId' '$deviceDesc' '$dataCount' '${qualityData[0]}' '$dataRate'"
...
if [ $chilledWaterFlowCombinedNum -ge 1 ]; then
	...
	echo "  bash ./plantFlowPPSSBR.sh $startDay $gId ${flowCombinedIEEE[0]} ${flowCombinedTable[0]} Main"
	bash ./plantFlowPPSSBR.sh $startDay $gId ${flowCombinedIEEE[0]} ${flowCombinedTable[0]} Main

	echo "  bash ./plantFlowPPSSBR.sh $startDay $gId ${flowCombinedIEEE[1]} ${flowCombinedTable[1]} PAHU"
	bash ./plantFlowPPSSBR.sh $startDay $gId ${flowCombinedIEEE[1]} ${flowCombinedTable[1]} PAHU
else
...
echo "  bash ./plantTempPerformanceMain.sh $startDay $startTime $endDay $endTime $gId"
bash ./plantTempPerformanceMain.sh $startDay $startTime $endDay $endTime $gId

echo "  bash ./plantTempPerformancePAHU.sh $startDay $startTime $endDay $endTime $gId"
bash ./plantTempPerformancePAHU.sh $startDay $startTime $endDay $endTime $gId
