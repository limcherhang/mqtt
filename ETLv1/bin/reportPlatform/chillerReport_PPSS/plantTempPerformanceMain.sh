...
where 
	gatewayId=$gId and 
	deviceDesc = 'ChilledWaterTempHDR#1'
;
"))
...
echo "REPlACE INTO dailyPlantWaterTemp(operationDate,siteId,gatewayId,name,
	...
	coolingDeltaData) 
VALUES('$startDay','$siteId','$gId','Main',
...
REPlACE INTO dailyPlantWaterTemp(operationDate,siteId,gatewayId,name,
	chillerSupplyMin,chillerSupplyMedian,chillerSupplyMax,
	chillerReturnMin,chillerReturnMedian,chillerReturnMax,
	coolingSupplyMin,coolingSupplyMedian,coolingSupplyMax,
	coolingReturnMin,coolingReturnMedian,coolingReturnMax,
