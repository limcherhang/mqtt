...
class MQTT():
    ...
    def conn(self):
        ...
        self.client.on_message = self.__on_message_raw # [('modbus/+/raw', 2), ('rawdata/modbus/raw', 2)]

        #self.client.message_callback_add(self.topic, self.__on_message_raw) # topic: modbus/raw
    ...
    def __on_connect(self, client, userdata, flags, rc):
        if rc == 0:
            ...
            self.client.subscribe(self.topic, qos=2) # [('modbus/+/raw', 2), ('rawdata/modbus/raw', 2)]
        elif rc == 1:
...
if __name__ == '__main__':
    ...
    logging.info(f"Protocol: Modbus")
