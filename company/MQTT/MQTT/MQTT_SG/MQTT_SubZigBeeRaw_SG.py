...
class MQTT():
    ...
    def conn(self):
        ...
        self.client.on_message = self.__on_message_raw # [('zigbee/+/raw', 2), ('rawdata/zb/raw', 2)]
    ...
    def __on_connect(self, client, userdata, flags, rc):
        if rc == 0:
            ...
            self.client.subscribe(self.topic, qos=2) # [('zigbee/+/raw', 2), ('rawdata/zb/raw', 2)]
        elif rc == 1:
        ...
        if len(msg_list) == 6:
            ...
            for index, s in enumerate(msg_list):
                if index == 2:
                    ...
                    new_msg += s + ', '
            logging.info(f"Receiving Message: '{new_msg[:-2]}' from {self.broker} on topic {message.topic}")
...
if __name__ == '__main__':
    ...
    try:
        ...
        subTopic_rawdata = 'zigbee/+/raw' # 'zigbee/+/raw'
        subTopic_rawdata_Hank = 'rawdata/zb/raw' # Hank's MQTT Topic: 'rawdata/zb/raw' for Zigbee
