...
sqlCommand="select siteId, name, gatewayId, protocol, dataETLName from mgmtETL.NameList where tableDesc='power' and gatewayId>0 and protocol is NOT NULL order by siteId, convert(substring_index(name, '#', -1), unsigned integer)"
