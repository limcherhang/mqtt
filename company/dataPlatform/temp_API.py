...
cursor = conn.cursor()
sqlCommand = f"select siteId, name, gatewayId, dataETLName, dataETLValue from mgmtETL.NameList where tableDesc='temp' and gatewayId=223 and protocol is not NULL"
