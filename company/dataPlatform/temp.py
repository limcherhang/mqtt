...
sqlCommand = f"select siteId, name, tableDesc, gatewayId, protocol, dataETLName, dataETLValue from mgmtETL.NameList where tableDesc='temp' and gatewayId>0 and protocol is not NULL and siteId!=35"
